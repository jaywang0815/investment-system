...
with tab1:
    ...
    if sns_df.empty:
        ...
        if prices:
            ...
            .pxc:hover{transform:translateY(-3px);border-color:var(--accent,#d11a22);
                       box-shadow:0 8px 22px rgba(21,163,90,.16);}
            .pxc-sym{font-size:.72rem;font-weight:700;letter-spacing:.5px;color:var(--muted,#64748b);}
            .pxc-val{font-size:1.3rem;font-weight:800;color:var(--accent,#d11a22);margin-top:4px;white-space:nowrap;}
